  ...
  snapshot.forEach(function(item) {
    ...
    for(var user in dataSet){
      ...
      dataSet[user].firebase.once('value', function(snapshot){ //for each kiwi in the user's collection
        ...
        //we now have each user's kiwis in dataSet[user].kiwis 
        //(which is an object who's keys are kiwi hashes). beginning phantom stuff...
...
var testKiwi = { 
  ...
  url: 'http://www.amazon.com/Olympus-Compact-System-Camera-3-Inch/dp/B00EQ07PG2/ref=sr_1_1?ie=UTF8&qid=1401309176&sr=8-1&keywords=omd+em1',
  destination: 'https://kiwidb.firebaseio.com/users/facebook:10103897713367983/kiwis/HASH01/values' 
};
